"""Korean-translated FRED indicator constants."""

from app.models import FredSeriesInfo

# ─── Indicator Categories ─────────────────────────────────────────────
INDICATOR_CATEGORIES: dict[str, list[dict]] = {
    "NATIONAL_ACCOUNTS": [
...
MAJOR_INDICATORS: list[FredSeriesInfo] = []
for category, items in INDICATOR_CATEGORIES.items():
    for item in items:
...
# Korean keyword → FRED Series ID mapping
